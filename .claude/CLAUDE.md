...
2. **Hero** (`#inicio`) — retrato full-bleed + overlay + H1 "Harmonia que respeita a sua *essência*" + botões WhatsApp e Instagram. Retrato: `assets/retrato-dra-tati-mayumi.jpeg`.
...
- **FAQ** (accordion): 7 perguntas de Botox + 8 de Preenchimento Labial + 7 de Bioestimulador de Colágeno (`FAQPage` JSON-LD aqui, espelhando as perguntas do accordion).
